...
- [x] **Components** - They're all there!
- [x] **Router** - See [app.jsx](src/app.jsx)
...
- [x] **Stores data in MongoDB** - Done! Registry items are stored in the database
- [x] **Stores credentials in MongoDB** - Done! Login information is stored in the database
